...
import 'package:flutter_riverpod/flutter_riverpod.dart';	class SettingsPage extends ConsumerStatefulWidget {
import 'package:flutter_screenutil/flutter_screenutil.dart';	  const SettingsPage({super.key});
import 'package:go_router/go_router.dart';	
import 'package:ringotrack/domain/drawing_app_preferences.dart';	  @override
import 'package:ringotrack/domain/drawing_app_preferences_controller.dart';	  ConsumerState<SettingsPage> createState() => _SettingsPageState();
import 'package:ringotrack/providers.dart';	}
import 'package:ringotrack/widgets/logs_view_sheet.dart';	
	class _SettingsPageState extends ConsumerState<SettingsPage> {
const _accent = Color(0xFF2CB36B);	  final TextEditingController _addAppController = TextEditingController();
const _deepAccent = Color(0xFF1F7A4A);	  final TextEditingController _deleteAppController = TextEditingController();
